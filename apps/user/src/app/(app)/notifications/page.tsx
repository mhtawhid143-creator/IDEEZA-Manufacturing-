...
/**
 * Notifications, with All and Unread as the design has them.
 *
 * The two filters are two routes rather than a query string, for the same reason
 * the hub tabs are: a filtered list has to stay linkable, and it is what the
 * bell in the navbar counts.
 */
