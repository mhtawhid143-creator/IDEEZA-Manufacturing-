  ...
  const sheets = [
    {
      ...
      attachmentNames: ['precisioncircuit-fab-capability.pdf'],
      position: 0,
      parameters: [
        { label: 'Layer support', values: ['16 layers'] },
        { label: 'Min hole size', values: ['0.2mm'] },
        { label: 'Surface finish', values: ['ENIG', 'HASL', 'OSP'] },
        { label: 'Material', values: ['FR-4', 'High-Tg FR4', 'Rogers 4350'] },
        { label: 'Copper', values: ['1oz', '2oz'] },
        { label: 'Impedance', values: ['plus or minus 7%'] },
    ...
    },
    {
      ...
      verification: 'verified' as const,
      attachmentNames: ['precisioncircuit-smt-line.pdf'],
      position: 1,
      parameters: [
        { label: 'Technology', values: ['SMT', 'Through-Hole', 'Mixed'] },
        { label: 'Min component size', values: ['0201'] },
        { label: 'IPC class', values: ['Class 3'] },
        { label: 'SMT lines', values: ['2 lines'] },
        { label: 'Build time', values: ['24-48 Hours'] },
      ],
    },
    {
      ...
      title: '3D Printing',
      verification: 'verified' as const,
      attachmentNames: ['additiveworks-print-capability.pdf'],
      position: 0,
      parameters: [
        { label: 'Technology', values: ['SLS', 'MJF', 'SLA'] },
        { label: 'Material', values: ['Nylon (PA12)', 'Nylon GF', 'Resin (Tough)'] },
        { label: 'Max print size', values: ['340 x 340 x 600 mm'] },
        { label: 'Resolution', values: ['60-120 micron layer height'] },
        { label: 'Batch production', values: ['Yes'] },
        { label: 'Build time', values: ['48-72 hours'] },
      ],
    },
    {
      // Written by the shop, not yet read by anyone at IDEEZA — which is what
      // the card's Pending chip is for.
      id: 'seed_sheet_c_cnc',
      manufacturerId: ID.manufacturerC,
      kind: 'cnc_machining' as const,
      title: 'CNC Machining',
      ...
      parameters: [
        ...
        { label: 'Tolerance', values: ['plus or minus 0.025mm'] },
        { label: 'Max work area', values: ['1200 x 700 x 500 mm'] },
        { label: 'Finish', values: ['As-Machined', 'Anodize type II'] },
